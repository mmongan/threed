import{S as e}from"./index-BLcY3y1L.js";import"./logDepthDeclaration-yi1h1qM5.js";import"./helperFunctions-Bt9qilMZ.js";import"./imageProcessingFunctions-PGkgJLPC.js";import"./clipPlaneFragment-D8xUFgnB.js";import"./fogFragment-CzlbI0fb.js";const o="decalFragmentDeclaration",L=`#ifdef DECAL
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=R);const c="samplerFragmentDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);const h="fresnelFunction",N=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=N);const v="reflectionFunction",y=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const u="bumpFragmentMainFunctions",O=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=O);const p="bumpFragmentFunctions",_=`#if defined(BUMP)
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=w);const Z={name:i,shader:w};export{Z as defaultPixelShader};
